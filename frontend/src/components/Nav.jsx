  ...
  return (
    <>
      {userSession.tipo === "admin" ? (
        ...
        <nav class="bg-white/50 dark:bg-gray-900 fixed w-full  top-0 start-0 border-b border-gray-200 dark:border-gray-600 z-50 backdrop-blur-md bg-opacity-50 h-16">
